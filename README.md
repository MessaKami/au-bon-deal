...
Un script de sauvegarde automatique (`backup_db.sh`) est inclus pour effectuer des sauvegardes journalières. Il est configuré pour stocker les sauvegardes dans le dossier `/home/messa/sites/simplon/au-bon-deal/doc/BDD/sauvegardes` et pour conserver les sept derniers jours de sauvegardes.
